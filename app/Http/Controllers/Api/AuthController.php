...
class AuthController extends Controller
{
    ...
    public function login(LoginRequest $request)
    {
        ...
        return $this->responseWithSuccess('Inicio sesión con éxito', AuthUserResource::make($user));
    }
    ...
    {
        return $this->responseWithSuccess('El usuario regresó exitosamente', UserResource::make(Auth::user()));
    }
    ...
    public function social(OAuthRequest $request)
    {
        try {
            ...
            $user['token'] = $user->createToken('main')->plainTextToken;
            return $this->responseWithSuccess('User social login successful', AuthUserResource::make($user));
